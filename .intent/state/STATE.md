...
- No accepted realization lock is selected. Candidates `0.1.0-candidate.1` and `0.1.0-candidate.2` failed live acceptance and are retained only as historical evidence; a replacement candidate has not yet been selected.
