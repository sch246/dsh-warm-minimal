...
let WarmMinimalRemote = (() => {
    let _classSuper = TypertRemoteService;
    let _instanceExtraInitializers = [];
    let _queryInventory_decorators;
    return class WarmMinimalRemote extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _queryInventory_decorators = [Remote('queryInventory')];
            __esDecorate(this, null, _queryInventory_decorators, { kind: "method", name: "queryInventory", static: false, private: false, access: { has: obj => "queryInventory" in obj, get: obj => obj.queryInventory }, metadata: _metadata }, null, _instanceExtraInitializers);
