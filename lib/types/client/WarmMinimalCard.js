    ...
    return (_jsxs("fieldset", { className: "dsh-warm-settings-segments", role: "radiogroup", "aria-label": `${props.t('assignment')}: ${sourceHeading(props.source, props.t)}`, disabled: props.disabled, children: [_jsxs("legend", { className: "dsh-warm-settings-sr-only", children: [props.t('assignment'), ": ", sourceHeading(props.source, props.t)] }), ASSIGNMENTS.map((assignment) => {
                ...
                return (_jsxs("label", { className: "dsh-warm-settings-segment", "data-checked": props.source.assignment === assignment, htmlFor: inputId, children: [_jsx("input", { id: inputId, name: `${props.list}-assignment-${controlId}`, type: "radio", value: assignment, checked: props.source.assignment === assignment, disabled: props.disabled, onChange: (event) => {
                                if (isSourceAssignment(event.target.value))
                                    props.onAssign(assignmentId(props.source), event.target.value);
...
function ToolSourceHeading(props) {
    return (_jsxs("span", { className: "dsh-warm-settings-source-copy", children: [_jsx("span", { className: "dsh-warm-settings-tool-name", children: props.source.name }), _jsx("span", { className: "dsh-warm-settings-tool-preview", children: props.source.description.length === 0 ? props.t('noDescription') : props.source.description })] }));
}
...
function SourceRow(props) {
    ...
    return (_jsxs("div", { className: "dsh-warm-settings-source", "data-source-row": props.list, children: [_jsxs("div", { className: "dsh-warm-settings-source-main", children: [_jsxs("button", { type: "button", className: "dsh-warm-settings-source-disclosure", "aria-expanded": expanded, "aria-controls": detailId, "aria-label": `${props.t(expanded ? 'hideDetails' : 'showDetails')}: ${sourceHeading(props.source, props.t)}`, onClick: () => { setExpanded(!expanded); }, children: [_jsx("span", { className: "dsh-warm-settings-source-chevron", "data-open": expanded, "aria-hidden": "true", children: "\u203A" }), 'id' in props.source
                ...
                ? (_jsxs("div", { id: detailId, className: "dsh-warm-settings-source-detail", children: [_jsxs("div", { className: "dsh-warm-settings-detail-source", children: [_jsx("span", { children: props.t('source') }), _jsx("code", { children: props.source.source })] }), 'id' in props.source
                            ? (_jsx("div", { className: "dsh-warm-settings-tool-details", children: _jsxs("div", { className: "dsh-warm-settings-tool-detail", children: [_jsx("strong", { children: props.t('descriptionLabel') }), _jsx("span", { children: props.source.description.length === 0
...
function SourceList(props) {
    return (_jsxs("details", { className: "dsh-warm-settings-source-section", "data-source-list": props.list, children: [_jsxs("summary", { className: "dsh-warm-settings-source-section-summary", children: [_jsxs("span", { className: "dsh-warm-settings-source-section-title", children: [_jsx("strong", { children: props.title }), _jsxs("span", { children: [props.countLabel, ": ", props.sources.length] })] }), _jsx(AssignmentSummary, { sources: props.sources, t: props.t })] }), _jsxs("div", { className: "dsh-warm-settings-source-section-body", children: [_jsx("p", { className: "dsh-warm-settings-hint", children: props.hint }), _jsx("div", { className: "dsh-warm-settings-source-list", children: props.sources.length === 0
                            ...
                            : props.sources.map(source => (_jsx(SourceRow, { list: props.list, source: source, disabled: props.disabled, t: props.t, onAssign: props.onAssign }, assignmentId(source)))) })] })] }));
}
/**
